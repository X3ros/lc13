	...
	if(proximity_flag && ishuman(target))
		if(user != target)
			if(uses > 0 && audio_cd < world.time)
				...
				playsound(src, 'ModularLobotomy/_Lobotomysounds/apostle/antagonist/whisper.ogg', 50, 1)
...
/obj/item/clothing/suit/armor/apostle
	...
	worn_icon = 'ModularLobotomy/_Lobotomyicons/teguclothing_worn.dmi'
...
/obj/item/nullrod/scythe/apostle
	...
	lefthand_file = 'ModularLobotomy/_Lobotomyicons/teguitems_hold_left.dmi'
	righthand_file = 'ModularLobotomy/_Lobotomyicons/teguitems_hold_right.dmi'
	icon = 'ModularLobotomy/_Lobotomyicons/teguitems.dmi'
	name = "holy scythe"
	desc = "None shall harm us."
	hitsound = 'ModularLobotomy/_Lobotomysounds/apostle/antagonist/scythe.ogg'
	force = 45
...
/obj/item/nullrod/scythe/apostle/attack_self(mob/living/carbon/user)
	...
	user.emote("spin")
	user.emote("flip")
	playsound(src, 'ModularLobotomy/_Lobotomysounds/apostle/antagonist/scythe_spell.ogg', 150, 1)
...
/obj/item/nullrod/scythe/apostle/guardian/light/attack_hand(mob/living/user)
	if(!bound && !(faction_needed in user.faction))
		...
		SEND_SOUND(user, 'ModularLobotomy/_Lobotomysounds/apostle/mob/apostle_bell.ogg')
...
/obj/item/gun/magic/staff/apostle/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0)
	...
	playsound(src, 'ModularLobotomy/_Lobotomysounds/apostle/antagonist/staff_charge.ogg', 100, 1)
...
/obj/item/nullrod/spear/apostle
	...
	hitsound = 'ModularLobotomy/_Lobotomysounds/apostle/antagonist/spear.ogg'
...
/obj/item/nullrod/spear/apostle/attack_self(mob/living/carbon/user)
	...
	playsound(src, 'ModularLobotomy/_Lobotomysounds/apostle/antagonist/spear_charge.ogg', 100, 1)
	if(!do_after(user, 25))
		return
	recharge_time = (world.time + recharge_time_base) // The real cooldown
	user.forceMove(final_T)
	playsound(src, 'ModularLobotomy/_Lobotomysounds/apostle/antagonist/spear_dash.ogg', 100, 1)
