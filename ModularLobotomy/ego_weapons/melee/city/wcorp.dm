...
/obj/item/ego_weapon/city/wcorp/dagger/ChargeAttack(mob/living/target, mob/living/user)
	...
	for(var/i = 1 to 3)
		sleep(0.2 SECONDS)
		target.deal_damage(force, damtype, user, flags = (DAMAGE_FORCED), attack_type = (ATTACK_TYPE_MELEE | ATTACK_TYPE_SPECIAL))
...
/datum/status_effect/interventionshield/wcorp
	statuseffectvisual = icon('ModularLobotomy/_Lobotomyicons/tegu_effects.dmi', "pale_shield")
