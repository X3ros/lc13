...
/obj/item/ego_weapon/the_claw
	...
	hitsound = 'ModularLobotomy/_Lobotomysounds/claw/attack.ogg'
...
/obj/item/ego_weapon/the_claw/dropped()
	...
	playsound(src, 'ModularLobotomy/_Lobotomysounds/claw/death.ogg', 50, TRUE)
	qdel(src)
	return ..()
...
/obj/item/ego_weapon/the_claw/proc/SwitchSerum(mob/living/user)
	...
	playsound(src, 'ModularLobotomy/_Lobotomysounds/claw/error.ogg', 50, TRUE)
...
/obj/item/ego_weapon/the_claw/attack_self(mob/living/user)
	...
	switch(serum)
		if("K")
			...
			playsound(src, 'ModularLobotomy/_Lobotomysounds/claw/prepare.ogg', 50, TRUE)
		...
		if("R")
			...
			playsound(src, 'ModularLobotomy/_Lobotomysounds/claw/r_prep.ogg', 50, TRUE)
			special_attack = TRUE
	...
	switch(serum)
		if("R") // Thanks helper
			...
			for(var/i = 1 to line_turfs.len)
				...
				playsound(user, 'ModularLobotomy/_Lobotomysounds/claw/move.ogg', 50, 1)
			...
			for(var/mob/living/L in mobs_to_hit)
				...
				playsound(L, 'ModularLobotomy/_Lobotomysounds/claw/stab.ogg', 25, 1)
		...
		if("W")
			...
			uhoh.orbit(A, 0)
			playsound(A, 'ModularLobotomy/_Lobotomysounds/claw/eviscerate1.ogg', 100, 1)
...
/obj/item/ego_weapon/the_claw/proc/SerumW(mob/living/user, mob/living/target) // It wasn't nice meeting you, farewell.
	...
	playsound(tp_loc, 'ModularLobotomy/_Lobotomysounds/claw/move.ogg', 100, 1)
	...
	playsound(user, 'ModularLobotomy/_Lobotomysounds/claw/w_portal.ogg', 50, 1)
	...
	for(var/i = 1 to 5) // Thanks egor
		...
		playsound(tp_loc, 'ModularLobotomy/_Lobotomysounds/claw/eviscerate2.ogg', 100, 1)
		tp_loc.Beam(target_turf, "nzcrentrs_power", time=15)
		playsound(target_turf, 'ModularLobotomy/_Lobotomysounds/claw/eviscerate2.ogg', 100, 1)
		user.forceMove(target_turf)
		...
		user.face_atom(target)
		sleep(4)
	playsound(user, 'ModularLobotomy/_Lobotomysounds/claw/w_slashes.ogg', 75, 1)
	user.face_atom(target)
	target.visible_message(
	...
	playsound(user, 'ModularLobotomy/_Lobotomysounds/claw/w_fin.ogg', 75, 1)
	target.visible_message(
...
/obj/item/ego_weapon/the_claw/proc/TriSerum(mob/living/user) // from PT, which was from Blue reverb
	...
	for(var/mob/living/L in range(12, user))
		...
		oh_dear.orbit(L, 0)
		playsound(L, 'ModularLobotomy/_Lobotomysounds/claw/eviscerate1.ogg', 25, 1)
	...
	for(var/mob/living/L in targets)
		...
		playsound(L, 'ModularLobotomy/_Lobotomysounds/claw/eviscerate2.ogg', 100, 1)
