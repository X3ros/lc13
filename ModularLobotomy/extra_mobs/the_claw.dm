/mob/living/simple_animal/hostile/megafauna/claw
	...
	attack_sound = 'ModularLobotomy/_Lobotomysounds/claw/attack.ogg'
	icon_state = "claw"
	icon_living = "claw"
	icon_dead = "claw_dead"
	...
	death_sound = 'ModularLobotomy/_Lobotomysounds/claw/death.ogg'
...
/mob/living/simple_animal/hostile/megafauna/claw/proc/eviscerate(mob/living/carbon/human/target)
	...
	uhoh.orbit(target, 0)
	playsound(target, 'ModularLobotomy/_Lobotomysounds/claw/eviscerate1.ogg', 100, 1)
	playsound(src, 'ModularLobotomy/_Lobotomysounds/claw/eviscerate1.ogg', 1, 1)
...
/mob/living/simple_animal/hostile/megafauna/claw/proc/eviscerate2(mob/living/carbon/human/target, obj/effect/eff)
	...
	if(prob(2) || target.z != z || !target.loc.AllowClick()) // Be happy, mortal. Did you just hide in a locker?
		...
		playsound(src.loc, 'ModularLobotomy/_Lobotomysounds/claw/error.ogg', 50, 1)
		qdel(eff)
		return
	...
	forceMove(tp_loc)
	qdel(eff)
	playsound(target, 'ModularLobotomy/_Lobotomysounds/claw/eviscerate2.ogg', 100, 1)
	GiveTarget(target)
...
/mob/living/simple_animal/hostile/megafauna/claw/proc/TargetSerumW(mob/living/L)
	...
	uhoh.orbit(L, 0)
	playsound(L, 'ModularLobotomy/_Lobotomysounds/claw/eviscerate1.ogg', 100, 1)
	playsound(src, 'ModularLobotomy/_Lobotomysounds/claw/prepare.ogg', 1, 1)
...
/mob/living/simple_animal/hostile/megafauna/claw/proc/triserum_eviscerate2(mob/living/carbon/human/target, obj/effect/eff)
	...
	playsound(target, 'ModularLobotomy/_Lobotomysounds/claw/eviscerate2.ogg', 100, 1, 7)
	GiveTarget(target)
	for(var/mob/living/L in range(1, get_turf(src))) // Attacks everyone around.
		if(L in been_hit)
			continue
...
/mob/living/simple_animal/hostile/megafauna/claw/proc/SwiftDash(atom/target, distance, wait_time)
	...
	playsound(src, 'ModularLobotomy/_Lobotomysounds/claw/prepare.ogg', 100, 1)
	icon_state = "claw_prepare"
	face_atom(target)
...
/mob/living/simple_animal/hostile/megafauna/claw/proc/blink(mob/living/LT)
	...
	if(!istype(LT) || QDELETED(LT))
		return
	forceMove(target_turf)
	playsound(src,'ModularLobotomy/_Lobotomysounds/claw/move.ogg', 100, 1)
