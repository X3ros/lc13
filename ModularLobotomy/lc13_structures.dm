...
/obj/structure/sign/button_counter
	...
	icon = 'ModularLobotomy/_Lobotomyicons/button_counter.dmi'
	is_editable = TRUE
	var/since_last = 0
...
/obj/structure/sign/button_counter/update_icon()
	...
	var/mutable_appearance/ones_overlay = mutable_appearance('ModularLobotomy/_Lobotomyicons/button_counter.dmi', "days_[ones]")
	ones_overlay.pixel_x = 4

	var/tens = (since_last / 10) % 10
	var/mutable_appearance/tens_overlay = mutable_appearance('ModularLobotomy/_Lobotomyicons/button_counter.dmi', "days_[tens]")
