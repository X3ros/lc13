...
/obj/machinery/clonepod/update_overlays()
	. = ..()
	if(mess)
		var/mutable_appearance/gib1 = mutable_appearance('ModularLobotomy/_Lobotomyicons/cloning/cryo_mobs.dmi', "gibup")
		var/mutable_appearance/gib2 = mutable_appearance('ModularLobotomy/_Lobotomyicons/cloning/cryo_mobs.dmi', "gibdown")
		...
		if(completion > 0.7)
			...
			occupant_overlay = mutable_appearance('ModularLobotomy/_Lobotomyicons/cloning/cryo_mobs.dmi', "clone_meat")
