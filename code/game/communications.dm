...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_CONTROL = FREQ_CONTROL,
	RADIO_CHANNEL_INFORMATION = FREQ_INFORMATION,
	RADIO_CHANNEL_SAFETY = FREQ_SAFETY,
	RADIO_CHANNEL_TRAINING = FREQ_TRAINING,
	RADIO_CHANNEL_COMMAND = FREQ_COMMAND,
	RADIO_CHANNEL_WELFARE = FREQ_WELFARE,
	RADIO_CHANNEL_DISCIPLINE = FREQ_DISCIPLINE,
	RADIO_CHANNEL_RECORDS = FREQ_RECORDS,
	RADIO_CHANNEL_EXTRACTION = FREQ_EXTRACTION,
	RADIO_CHANNEL_ARCHITECTURE = FREQ_ARCHITECTURE,
	RADIO_CHANNEL_CENTCOM = FREQ_CENTCOM,
	RADIO_CHANNEL_SYNDICATE = FREQ_SYNDICATE,
	RADIO_CHANNEL_HEAD = FREQ_HEAD,
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_CONTROL]" = RADIO_CHANNEL_CONTROL,
	"[FREQ_INFORMATION]" = RADIO_CHANNEL_INFORMATION,
	"[FREQ_SAFETY]" = RADIO_CHANNEL_SAFETY,
	"[FREQ_TRAINING]" = RADIO_CHANNEL_TRAINING,
	"[FREQ_COMMAND]" = RADIO_CHANNEL_COMMAND,
	"[FREQ_WELFARE]" = RADIO_CHANNEL_WELFARE,
	"[FREQ_DISCIPLINE]" = RADIO_CHANNEL_DISCIPLINE,
	"[FREQ_RECORDS]" = RADIO_CHANNEL_RECORDS,
	"[FREQ_EXTRACTION]" = RADIO_CHANNEL_EXTRACTION,
	"[FREQ_ARCHITECTURE]" = RADIO_CHANNEL_ARCHITECTURE,
	"[FREQ_CENTCOM]" = RADIO_CHANNEL_CENTCOM,
	"[FREQ_SYNDICATE]" = RADIO_CHANNEL_SYNDICATE,
	"[FREQ_HEAD]" = RADIO_CHANNEL_HEAD,
