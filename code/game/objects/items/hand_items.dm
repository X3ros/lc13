...
//obj/item/hand_item/slapper/attack_atom(obj/O, mob/living/user, params) - REQUIRES PR #61183
/obj/item/hand_item/slapper/attack_obj(obj/O, mob/living/user, params)
	if(!istype(O, /obj/structure/table))
		return ..()

	var/obj/structure/table/the_table = O
//	var/is_right_clicking = LAZYACCESS(params2list(params), RIGHT_CLICK) LOBOTOMYCORPORATION REMOVAL - we dont use combat mode
...
/* LOBOTOMYCORPORATION REMOVAL - We dont have memories
