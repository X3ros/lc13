...
/obj/item/clothing/suit/space/hardsuit
	...
	max_integrity = 300
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 0, BLACK_DAMAGE = 0, PALE_DAMAGE = 0)
	allowed = list(/obj/item/flashlight, /obj/item/tank/internals, /obj/item/t_scanner, /obj/item/construction/rcd)
...
/obj/item/clothing/head/helmet/space/hardsuit/syndi
	...
	hardsuit_type = "syndi"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 30, BLACK_DAMAGE = 30, PALE_DAMAGE = 30)
	on = TRUE
...
/obj/item/clothing/head/helmet/space/hardsuit/syndi/proc/toggle_hardsuit_mode(mob/user) //Helmet Toggles Suit Mode
	if(linkedsuit)
		if(on)
			...
			linkedsuit.name = "[initial(linkedsuit.name)] (combat)"
...
/obj/item/clothing/head/helmet/space/hardsuit/syndi/elite
	...
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 40, BLACK_DAMAGE = 40, PALE_DAMAGE = 40)
	heat_protection = HEAD
	max_heat_protection_temperature = TRUE
...
/obj/item/clothing/head/helmet/space/hardsuit/clown
	...
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 50, BLACK_DAMAGE = 40, PALE_DAMAGE = 20)
	hardsuit_type = "clown"
...
/obj/item/clothing/suit/space/hardsuit/shielded/ctf
	...
	armor = list(RED_DAMAGE = 0, WHITE_DAMAGE = 0, BLACK_DAMAGE = 40, PALE_DAMAGE = 0)
	slowdown = 0
	max_charges = 5
