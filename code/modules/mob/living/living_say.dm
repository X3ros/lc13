...
GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	RADIO_KEY_CONTROL = RADIO_CHANNEL_CONTROL,
	RADIO_KEY_INFORMATION = RADIO_CHANNEL_INFORMATION,
	RADIO_KEY_SAFETY = RADIO_CHANNEL_SAFETY,
	RADIO_KEY_TRAINING = RADIO_CHANNEL_TRAINING,
	...
	RADIO_KEY_HEAD = RADIO_CHANNEL_HEAD,
	...
	// Department
	"р" = MODE_DEPARTMENT,
	"к" = RADIO_CHANNEL_CONTROL,
	"ш" = RADIO_CHANNEL_INFORMATION,
	"ы" = RADIO_CHANNEL_SAFETY,
	"е" = RADIO_CHANNEL_TRAINING,
