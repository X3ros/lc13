...
/mob/living/simple_animal/hostile/guardian/dextrous
	...
	damage_coeff = list(BRUTE = 0.75, FIRE = 0.75, TOX = 0.75, CLONE = 0.75, STAMINA = 0, OXY = 0.75)
...
/mob/living/simple_animal/hostile/guardian/dextrous/can_equip(obj/item/I, slot, disable_warning = FALSE)
	switch(slot)
