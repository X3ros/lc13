...
/mob/living/simple_animal/hostile/ooze/gelatinous
	...
	speed = 1
	damage_coeff = list(BRUTE = 1, FIRE = 0.6, TOX = 0.5, CLONE = 1.5, STAMINA = 0, OXY = 1)
...
/datum/action/consume/process()
	...
	ooze.heal_ordered_damage((ooze.maxHealth * 0.03), list(BRUTE, FIRE, OXY)) ///Heal 6% of these specific damage types each process
...
/mob/living/simple_animal/hostile/ooze/grapes
	...
	health = 200
	maxHealth = 200
	damage_coeff = list(BRUTE = 1, FIRE = 0.8, TOX = 0.5, CLONE = 1.5, STAMINA = 0, OXY = 1)
